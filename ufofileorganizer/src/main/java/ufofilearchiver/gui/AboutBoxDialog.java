...
public class AboutBoxDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ufofilearchiver.gui.UfoFileArchiverGUI.class).getContext().getResourceMap(AboutBoxDialog.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ufofilearchiver.gui.UfoFileArchiverGUI.class).getContext().getActionMap(AboutBoxDialog.class, this);
