...
public class DesktopApplication1AboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ufofileorganizer.gui.swing.DesktopApplication1.class).getContext().getResourceMap(DesktopApplication1AboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ufofileorganizer.gui.swing.DesktopApplication1.class).getContext().getActionMap(DesktopApplication1AboutBox.class, this);
